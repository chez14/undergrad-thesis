...
\subsubsection{Detil Ujian: Fitur notifikasi}
    ...
    \begin{figure}[]
        \centering
        \includegraphics[width=0.6\paperwidth]{Gambar/mockups/Mockup--Admin - Notif Delete.pdf}
...
\subsubsection{Detil Ujian: Daftar Hadir}
    \begin{figure}
        \centering
        \includegraphics[width=0.7\paperwidth]{Gambar/mockups/Mockup--Admin - Daftar Hadir.pdf}
...
\subsubsection{Pengelola Entitas: Buat dan Ubah Entri Baru}
    \begin{figure}
        \centering
        \includegraphics[width=0.6\paperwidth]{Gambar/mockups/Mockup--Admin - Entity Editor.pdf}
