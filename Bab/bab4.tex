...
\subsubsection{Detil Ujian: Fitur notifikasi}
    ...
    \end{figure}
    Untuk menghapus notifikasi ujian, tim admin dapat menekan tombol yang nantinya
    akan menampilkan modal untuk konfirmasi penghapusan. Rancangan tampilan modal
    tersebut dapat diperhatikan pada Gambar \ref{fig:mockup_admin_notif_delete}.
    Modal akan menampilkan informasi badan notifikasi dan tombol aksi.
