...
\subsubsection{\textit{Namespace} \texttt{app/controller}}
    ...
    \texttt{app/controller/api/manage} yang memiliki banyak kelas turunan dari
...
\subsection{\textit{Namespace} \texttt{app/service}, \texttt{app/cronjob} dan
\texttt{app/view}}
    \begin{figure}
        \centering
