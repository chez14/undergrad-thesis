...
\subsection{Rancangan Antarmuka untuk Peserta}
    ...
    kredensial login dan pengumuman lainnya.
     ...
     tidak ada ujian yang sedang ditautkan ke komputer tersebut pada waktu tertentu. Hal ini diperuntukan
     untuk membantu tim admin melakukan pengecekan lebih cepat karena tampilan layar yang beda secara
     signifikan. Selain itu, tampilan pesan yang cukup ramah untuk pengguna menampilkan informasi bahwa mungkin
     peserta salah mengambil tempat duduk.
...
\subsubsection{Otentikasi}
    ...
    terlebih dahulu. Otentikasi untuk admin panel ...
...
\subsubsection{Timer Ujian}
    ...
    pengguna sedang membuka \textit{tab} Timer, maka kepala \textit{tab} yang aktif menunjukan
    kepala \textit{tab} timer. Dosen pengawas dapat melakukan 
