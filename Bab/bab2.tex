...
\section{Perangkat Lunak Berbasis Web}
    ...
    aplikasi tidak hanya berjalan pada \textit{server} atau server saja, maka
...
\section{\textit{Library} dan \textit{Framework}}
    ...
    saat tahap pengembangan para pengembang dapat lebih fokus untuk
    mengimplementasi fitur program, dibandingkan dengan pengembang harus
    menyelesaikan \textit{bug-bug} yang seharusnya tidak perlu ada.
