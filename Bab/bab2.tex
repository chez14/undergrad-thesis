...
\subsection{Front-end}
    ...
    Sesuai dengan namanya, subsistem front-end akan berjalan pada sisi klien dari
...
\section{GitLab CI/CD}
    ...
    \begin{figure}
        \begin{minipage}{\textwidth}
            ...
            \caption{Eksekusi \textit{job} yang gagal pada GitLab CI/CD. Repositori dari Pho - FTIS OpenData App\footnote{Lihat https://gitlab.com/chez14/ftis-opendata-app}}
